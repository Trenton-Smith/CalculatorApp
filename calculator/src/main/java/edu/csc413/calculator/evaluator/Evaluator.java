...
public class Evaluator {
  ...
  public Stack<Operand> getOperandStack(){return operandStack;}
  public Stack<Operator> getOperatorStack(){return operatorStack;}
...
//          System.out.println(newOperator);
          ...
          if (newOperator.priority()==-1){//first check - if token is left parenthesis, push to stack
            operatorStack.push(newOperator);
            //System.out.println("______________________________________WE ARE HERE IN THE CODE_______________________________________");
            continue;
          }else if(newOperator.priority()==-2){//second check - if token is right parenthesis,
          ...
          operatorStack.push( newOperator ); //if operatorStack.isEmpty() is TRUE, we push the operator by default
        }
      }
    }
